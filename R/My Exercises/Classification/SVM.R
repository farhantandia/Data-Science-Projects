...
#For Classification
trainc$Start_Tech_Oscar<-as.factor(trainc$Start_Tech_Oscar) #change range value to levels
...
#Polynomial kernel
svmfit = svm(Start_Tech_Oscar~., data=trainc, kernel = 'polynomial', degree=2,cost=1 )
summary(svmfit)
...
df <- read.csv("C:/Users/farha/Documents/GitHub/Data Science Projects/R/Data Files/Decision Tree Dataset/Movie_regression.csv", header = TRUE)
